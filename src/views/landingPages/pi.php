                ...
                <section style="z-index:-1;">
                        ...
                        <div class="lpage3-card-container-1">
                            <div class="lpage3-card">
                                <div class="lpage3-card-name">
                                    <h4>01 . තොරතුරු සහ සන්නිවේදන තාෂණය</h4>
                                    <br>
                                </div>
                    ...
                    <div class="lpage3-card-container">
                        <div class="lpage3-card-container-1">
                            ...
                            <div class="lpage3-card">
                                <div class="lpage3-card-name">
                                    <h4>04 . අංකිත පරිඵථවල මූලකාංග</h4>
                                    <br>
                                </div>
                                <div class="lpage3-card-1">
                ...
                <section style="z-index:-1;">
                    ...
                    <div class="lpage3-card-container">
                        <div class="lpage3-card-container-1">
                            <div class="lpage3-card">
                                <div class="lpage3-card-name">
                                    <h4>05 . පරිගණක මෙහයුම් පද්ධති</h4>
                                    <br>
                                </div>
                                <div class="lpage3-card-1">
                            ...
                            <div class="lpage3-card">
                                <div class="lpage3-card-name">
                                    <h4>06 . දත්ත සන්නිවේදනය හා ජාලකරණය</h4>
                                    <br>
                                </div>
                                <div class="lpage3-card-1">
                    ...
                    <div class="lpage3-card-container">
                        <div class="lpage3-card-container-1">
                            <div class="lpage3-card">
                                <div class="lpage3-card-name">
                                    <h4>07 . පද්ධත විශ්ලේෂණය හා පරිසැලසුම</h4>
                                    <br>
                                </div>
                                <div class="lpage3-card-1">
                            ...
                            <div class="lpage3-card">
                                <div class="lpage3-card-name">
                                    <h4>08 . දත්ත සමුදාය කළමනාකරණය</h4>
                                    <br>
                                </div>
                                <div class="lpage3-card-1">
                ...
                <section style="z-index:-1;">
                    ...
                    <div class="lpage3-card-container">
                        <div class="lpage3-card-container-1">
                            <div class="lpage3-card">
                                <div class="lpage3-card-name">
                                    <h4>11 . සාර්ව ද්‍රවය අන්තර්ජාලය</h4>
                                    <br>
                                </div>
                                <div class="lpage3-card-1">
